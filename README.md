...
- ⚙️ **Governed collaboration** - Enable multiple users to collaborate simultaneously with built-in governance and a complete history of changes via [Git or shared workspaces](https://docs.snowflake.com/en/user-guide/ui-snowsight/workspaces).
